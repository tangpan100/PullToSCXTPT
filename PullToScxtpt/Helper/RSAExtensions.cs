...
{
    /// <summary>
    ///  把java的私钥转换成.net的xml格式，java->.net 
    /// </summary>
    /// <param name="rsa"></param>
    /// <param name="privateJavaKey"></param>
    /// <returns></returns>
    public static string ConvertToXmlPrivateKey(this System.Security.Cryptography.RSA rsa, string privateJavaKey)
    {
    ...
    /// <returns></returns>
    public static void FromPrivateKeyJavaString(this System.Security.Cryptography.RSA rsa, string privateJavaKey)
    {
    ...
    /// RSA私钥格式转换，.net->java    
    /// </summary>    
    /// <param name="privateCSharpKey">.net生成的私钥</param>    
    /// <returns></returns>   
    public static string ConvertToJavaPrivateKey(this System.Security.Cryptography.RSA rsa, string privateCSharpKey)
    {
        XmlDocument doc = new XmlDocument();
        doc.LoadXml(privateCSharpKey);
