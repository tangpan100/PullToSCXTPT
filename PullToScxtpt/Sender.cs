    ...
    public  class Sender
    {
        ...
        public  void CallWebService()
        {
            ...
            for (int i = 0; i < clist.Count; i++)
            {
                ...
                string soap = GetSoapInsertCompanyStr(systemKey, inputxml, sign);
                ...
                if (code == "1")
                {
                    SqlHelper.ExecuteNonQuery("insert into PullInfoRecord(number,UpdateTime,type)values(@number,@UpdateTime,@type)",
                        ...
                        new SqlParameter("@UpdateTime", "getdate()"),
        ...
        string GetSoapDeleteCompanyStr(string systemKey, string source, string sign)
        {
            ...
            soap.Append("<jybh>scggzp_delete_ab01</jybh>");
        ...
        string GetSoapInsertCompanyStr(string systemKey,string source,string sign)
        {
            StringBuilder soap = new StringBuilder();
            soap.Append("<?xml version='1.0' encoding='UTF - 8'?>");
            soap.Append("<soap:Envelope xmlns:soap='http://schemas.xmlsoap.org/soap/envelope/'>");
